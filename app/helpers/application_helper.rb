...
puts "title: " + document['journal_title_t'].inspect
puts "page: " + document['journal_page_t'].inspect
puts "vol: " + document['journal_vol_t'].inspect
puts "recordid_doi_t: " + document['recordid_doi_t'].inspect
puts "recordid_doi_t: " + document['recordid_doi_t'].inspect
puts "author_name_t: " + document['author_name_t'].inspect
puts "title_s: " + document['title_s'].inspect
